 ...
 */
 ...
 const lgas = require('../providers/locations/localgvmt')
 
 /**
  * Number Provider
  */
 const { networks, prefix } = require('../providers/phonenumber')
...
//  if null or empty run ? hence if null generate a random value
